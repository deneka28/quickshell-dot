...
Singleton {
    ...
    component BrightnessMonitor: QtObject {
        ...
        onBrightnessChanged: {
            ...
            OsdService.showBrightness(monitor.brightness); // добавь
        ...
        readonly property Process watchProc: Process {
        ...
        function syncBrightness() {
            ...
            setProc.command = isDdc ? ["ddcutil", "-b", busNum, "setvcp", "10", rawValueRounded] : ["brightnessctl", "set", rawValueRounded.toString()];
